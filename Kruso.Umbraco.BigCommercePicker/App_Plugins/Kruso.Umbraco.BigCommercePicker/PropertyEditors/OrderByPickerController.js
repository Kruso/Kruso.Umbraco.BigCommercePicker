function bigCommerceOrderByPickerController($scope, eventsService) {
    ...
    var unsubscribe = eventsService.on("bigCommerce.entityTypeChanged", setAvailableOptions);
...
angular.module('umbraco').controller("Kruso.Umbraco.BigCommercePicker.PropertyEditors.OrderByPickerController", bigCommerceOrderByPickerController);